...
public:
    ...
    static void G303();
    static void supermoveZ(boolean moveDown,int speed);
    static void moveZ(boolean moveDown,int speed);
    static void servoPass(int angle);
    static void delay2(uint32_t delay);
    static boolean CheckForBead(uint32_t checkTime);
