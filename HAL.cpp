...
#if PDM_FOR_COOLER
        pulseDensityModulate(FAN3_PIN, MAX_FAN_PWM,  pwm_pos_set[PWM_FAN3], false);
#else
        if((MAX_FAN_PWM & COOLER_PWM_MASK) == pwm_count_cooler && (MAX_FAN_PWM & COOLER_PWM_MASK) != COOLER_PWM_MASK) WRITE(FAN3_PIN, 0);
#endif
    }
#endif
